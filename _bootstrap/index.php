...
if (!createObject('modNamespace',array(
    'name' => 'commerce_mpdfwriter',
    'path' => $componentPath.'/core/components/commerce_mpdfwriter/',
    'assets_path' => $componentPath.'/assets/components/commerce_mpdfwriter/',
),'name', false)) {
    echo "Error creating namespace commerce_mpdfwriter.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_mpdfwriter.core_path',
    'value' => $componentPath.'/core/components/commerce_mpdfwriter/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_mpdfwriter',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_mpdfwriter.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_mpdfwriter.assets_path',
    'value' => $componentPath.'/assets/components/commerce_mpdfwriter/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_mpdfwriter',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_mpdfwriter.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_mpdfwriter/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_mpdfwriter.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_mpdfwriter',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_mpdfwriter.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_mpdfwriter.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_mpdfwriter/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_mpdfwriter/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce_mPDFWriter\\Modules\\', $modulePath);
